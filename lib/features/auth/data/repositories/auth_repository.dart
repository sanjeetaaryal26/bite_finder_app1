...
import 'package:bite_finder_app/core/services/connectivity/network_info.dart';
import 'package:bite_finder_app/features/auth/data/datasources/auth_datasource.dart';
import 'package:bite_finder_app/features/auth/data/datasources/local/auth_local_datasource.dart';
import 'package:bite_finder_app/features/auth/data/datasources/remote/auth_remote_datasource.dart';
...
class AuthRepository implements IAuthRepository {
  ...
  @override
  Future<Either<Failure, AuthEntity>> getCurrentUser(String uid) async {
    try {
      final model = await _authDataSource.getCurrentUser(uid);
      if (model != null) {
        final entity = model.toEntity();
        return Right(entity);
      }
